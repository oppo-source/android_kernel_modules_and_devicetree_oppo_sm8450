...
static struct cam_irq_controller_reg_info cam_ife_csid_680_top_irq_reg_info = {
	.num_registers = 1,
	.irq_reg_set = &cam_ife_csid_680_irq_reg_set[0],
...
static struct cam_irq_controller_reg_info cam_ife_csid_680_rx_irq_reg_info = {
	.num_registers = 1,
	.irq_reg_set = &cam_ife_csid_680_irq_reg_set[1], /* RX */
...
static struct cam_irq_controller_reg_info cam_ife_csid_680_path_irq_reg_info[7] = {
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[2], /* RDI0 */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[3], /* RDI1 */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[4], /* RDI2 */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[5], /* RDI3 */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[6], /* RDI4 */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[7], /* IPP */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
	{
		.num_registers = 1,
		.irq_reg_set = &cam_ife_csid_680_irq_reg_set[8], /* PPP */
		.global_clear_offset  = 0, /* intentionally set to zero */
	},
};
...
static struct cam_ife_csid_csi2_rx_reg_info
	cam_ife_csid_680_csi2_reg_info = {
		...
		.fatal_err_mask                  = 0x197A000,
		.part_fatal_err_mask             = 0x081800,
		.non_fatal_err_mask              = 0x0200000,
		.phy_recovery_mask               = 0x18BB800,
		.top_irq_mask                    = 0x4,
};
